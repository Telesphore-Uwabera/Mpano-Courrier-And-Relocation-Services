( () => {
    ...
    i.O = (r, t, o, n) => {
        if (!t) {
            ...
            for (c = 0; c < e.length; c++) {
                for (var [t,o,n] = e[c], a = !0, f = 0; f < t.length; f++)
                    (!1 & n || l >= n) && Object.keys(i.O).every((e => i.O[e](t[f]))) ? t.splice(f--, 1) : (a = !1,
                    n < l && (l = n));
                if (a) {
                    e.splice(c--, 1);
                    var u = o();
    ...
    ( () => {
        ...
        var r = (r, t) => {
          ...
          , t = globalThis.webpackChunkshop = globalThis.webpackChunkshop || [];
